package com.ming.ppsg.tool.date;
...
public class DatesUtil {
    ...
    public static void main(String[] args) {
        Date date1 = getBeginWeek(0);
        Date date2 = getEndWeek(0);
    ...
    public static Date getBeginWeek(Integer week) {
        Date date = new Date();
        if (date == null) {
            return null;
        }
    ...
    // 获取本周、上周、下周的结束时间
    public static Date getEndWeek(Integer week) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(getBeginWeek(week));
