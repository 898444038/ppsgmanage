...
import com.ming.ppsg.client.ppsg.service.impl.config.ConfigGeneralsTypeServiceImpl;

@FeignClient(name = "ppsg-server",fallback = ConfigGeneralsTypeServiceImpl.class)
